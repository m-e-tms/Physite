...
<head>
<meta charset="UTF-8">
<title>Spielende – Progressivmodus</title>
<style>
    body { margin:0; font-family:Arial,sans-serif; background:#9ac7e3; display:flex; justify-content:center; align-items:center; min-height:100vh; }
    ...
    a.button-link { display:inline-block; text-decoration:none; width:100%; padding:12px; border-radius:10px; background:#457b9d; color:white; font-size:16px; transition:0.2s; box-sizing:border-box; }
    a.button-link:hover { background:#5e368c; }
    a.button-link.home { background:#800080; }
    a.button-link.home:hover { background:#5e368c; }
...
<div class="end-screen">
  <h1>Spielende</h1>
  <p>Die Eingabe war falsch oder die Zeit ist abgelaufen.</p>
  <div class="stats"><p>Erreichtes Level: <?= $level ?> mit <?= $scoreAdj ?> Punkten</p></div>
