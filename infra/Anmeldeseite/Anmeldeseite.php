...
if (!empty($_SESSION['user_id'])) {
    header('Location: ../Hub_Lernseite_Mint.php');
    exit;
}
...
<main class="stage">
    ...
    <p class="reg-hint">Noch kein Accounto? <a href="../Registrierungsseite/Registrierungsseite.php">Jetzt registrieren</a></p>
    <a class="back-link" href="../Auswahlseite/index.php">← Zurück zur Startseite</a>
</main>
